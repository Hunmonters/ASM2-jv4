...
input[type="email"]{
  ...
  border:1px solid #dfe5f1; border-radius:12px; background:#fff;
...
/* Messages */
.message, .error{
  text-align:center; font-weight:700; padding:10px 14px; margin:10px auto 0;
  width:min(600px, 90%);
  border-radius:12px; border:1px solid transparent;
}
.message:empty, .error:empty{ display:none; }
.message{ color:#166534; background:#dcfce7; border-color:#bbf7d0; }
    ...
    <form class="register-box" action="register" method="post">
      ...
      <div class="body">
        <div class="form-group">
          ...
          <input type="text" name="id" id="id" placeholder="vd: nguyenvana" required />
        </div>
